        ...
        <section className="bg-gradient-to-b from-[#0B1623] to-blue-950 lg:px-60 py-30">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-4">
              ...
              <button className="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 hover:scale-110 transition">
                Save
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-15">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-3 mt-4">
                <span className="px-3 py-1 bg-gradient-to-b from-indigo-950 border-2 border-transparent 
               bg-gradient-to-l from-indigo-950 to-gray-800 text-lg text-white rounded-lg">
                  Mobile Application
                </span>
                <span className="px-3 py-1 bg-gradient-to-b from-indigo-950 border-2 border-transparent 
               bg-gradient-to-l from-indigo-950 to-gray-800 text-lg text-white rounded-lg">
          ...
          <div className="mt-20">
            <label className="text-white text-3xl font-semibold block mb-4">Note</label>
            <textarea
          ...
          {/* Delete Button */}
          <div className="flex justify-end mt-25 mr-9">
                <button className="bg-red-600 text-white px-4 py-1 h-12 rounded-lg hover:bg-red-700 hover:scale-110 transition">
                  Delete Portfolio
                </button>
            </div>
