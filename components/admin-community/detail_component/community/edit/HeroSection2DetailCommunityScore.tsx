...
const HeroSection2DetailCommunityScore = () => {
    ...
    <section className=" text-white lg:px-100 py-1 px-20 ">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-6 flex justify-end py-15">
          ...
          <button
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold transition ml-5"
...
export default HeroSection2DetailCommunityScore;
